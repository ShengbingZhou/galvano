...
-- Module  Version: 5.7
--C:\lscc\diamond\3.7_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_module -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 20 -phase_cntl STATIC -bypasss -fclkop 50 -fclkop_tol 0.0 -fb_mode CLOCKTREE -phaseadj 0.0 -duty 8 -fclkok 5 -fclkok_tol 0.0 -norst -noclkok2 
...
architecture Structure of pll_module is
    ...
    attribute CLKOS_BYPASS of PLLInst_0 : label is "ENABLED";
    ...
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "5.000000";
    attribute CLKOK_DIV of PLLInst_0 : label is "10";
    ...
    attribute FIN of PLLInst_0 : label is "20.000000";
...
begin
    ...
    PLLInst_0: EPLLD1
        -- synopsys translate_off
        generic map (CLKOK_BYPASS=> "DISABLED", CLKOS_BYPASS=> "ENABLED", 
        CLKOP_BYPASS=> "DISABLED", PHASE_CNTL=> "STATIC", DUTY=>  8, 
        PHASEADJ=> "0.0", CLKOK_DIV=>  10, CLKOP_DIV=>  16, CLKFB_DIV=>  5, 
        CLKI_DIV=>  2)
        -- synopsys translate_on
        port map (CLKI=>CLK, CLKFB=>CLKOP_t, RST=>scuba_vlo, 
            ...
            CLKOS=>CLKOS, CLKOK=>CLKOK, LOCK=>LOCK, CLKINTFB=>open);
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of pll_module is
    for Structure
