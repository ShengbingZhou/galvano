...
set Para(ModuleName) "MultiplierS16"
set Para(Module) "Multiplier"
set Para(libname) latticexp2
set Para(arch_name) mg5a00
set Para(PartType) "LFXP2-8E"

set Para(tech_syn) latticexp2
set Para(tech_cae) latticexp2
